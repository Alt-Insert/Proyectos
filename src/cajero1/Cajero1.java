...
public class Cajero1 {
    ...
    public static void main(String[] args) {
        ...
        String globalUsuario; // usuario por defecto
        String globalPass; // contraseña por defecto
        ...
        String cNombre;
        String cPass;
        String cGlobalUsuario;
        String cGlobalPass;

        cGlobalUsuario = JOptionPane.showInputDialog(null, "Ingrese usuario");         //ingresamos un usuario 
        cGlobalPass = JOptionPane.showInputDialog(null, "Ingrese su contraseña");     //colocamos contraseña
        ...
        do {
            ...
            if (cNombre.equals(cGlobalUsuario) && cPass.equals(cGlobalPass)) {
            ...
            switch (opcionLocal) {
                ...
                case 3:             //Realizamos la extraccion
                    ...
                    do {    //Con la funcion Do While Realizamos un repetidor si ingresa la contraseña mal para 
                        ...
                        if (cPass.equals(cPass) && extraccion <= 1000 && extraccion % 10 == 0) {
